...
class nnUNetTrainer(object):
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        #inigo
        IoU = tp/(tp+fp+fn)
        self.logger.log('iou', IoU, self.current_epoch)    
        self.logger.log('confusion', [tp,fp,fn, world_size], self.current_epoch)   #******
    ...
    def on_epoch_end(self):
        ...
        for key in self.logger.my_fantastic_logging:
            ...
            print('epoch:', self.current_epoch, key, self.logger.my_fantastic_logging[key][-1])

        print("+++NEW EPOCH+++")
        print('epoch:', self.current_epoch)
        print('VAL LOSS',self.logger.my_fantastic_logging['val_loss'][-1])
        print('TRAIN LOSS',self.logger.my_fantastic_logging['train_losses'][-1])
        print('dice_per_class_or_region',self.logger.my_fantastic_logging['dice_per_class_or_region'][-1])
        print("---NEW EPOCH---")
