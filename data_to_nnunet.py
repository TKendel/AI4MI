...
for patient in patient_list:
        ...
        volume_destination = os.path.join('Dataset010_SEGT/nnUNet_raw/Dataset001_segthor/imagesTr/', 'SEGT_'+f"{patient:03}"+'_0000.nii.gz')
        ...
        segmentation_destination = os.path.join('Dataset010_SEGT/nnUNet_raw/Dataset001_segthor/labelsTr/', 'SEGT_'+f"{patient:03}"+'.nii.gz')
